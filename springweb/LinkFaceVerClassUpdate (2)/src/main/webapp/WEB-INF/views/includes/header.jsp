                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="/main">All Foods</a></li>
                        ...
                        <sec:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_MANAGER' , 'ROLE_MEMBER')">
                            <a class="btn btn-outline-dark" type="submit" href="/jjim" >
                                <i class="bi-bag-check me-1"></i>
                                    찜목록
                                <span class="badge bg-dark text-white ms-1 rounded-pill"></span>
                            </a>
                            <a class="btn btn-info" type="submit" href="/userpage" >
                                    내 정보
                                <span class="badge bg-dark text-white ms-1 rounded-pill"></span>
                            </a>
                        </sec:authorize>
